...
Salve pessoal, comecei esse repositório para ajudar aqueles que assim como eu esteja buscando bolsas de estudos / estágios internacionais que tenham ajuda de custo. Este repositório é focado em <b>estudantes brasileiros</b> que estejam cursando o <b>nível superior</b>, mas pode haver algumas bolsas que contemplem outros níveis de escolaridade.
...
<table role="table">
  ...
  <tbody>
    ...
    <tr>
      <td>
        <a href="https://www2.daad.de/deutschland/stipendium/datenbank/en/21148-scholarship-database/?detail=50076777" target="_BLANK"> DAAD</a>
      </td>
      <td>
        <ul>
...
<table role="table">
  ...
  <tbody>
    <tr>
      <td>
        <a href="https://www.menteargentina.com/3/Study-Abroad-Programs/12/Academic-Semester-Program" target="_BLANK">Mente Argentina - Academic Semester Program</a>
      </td>
      <td>
        <ul>
          <li>
...
<table role="table">
  ...
  <tbody>
    <tr>
      <td>
        <a href="https://globalink.mitacs.ca/#/student/application/welcome" target="_BLANK"> MITACS</a>
      </td>
      <td>
        <ul>
    ...
    <tr>
      <td>
        <a href="https://www.educanada.ca/scholarships-bourses/can/institutions/elap-pfla.aspx?lang=eng" target="_BLANK">Emerging Leaders in the Americas Program(ELAP)</a>
      </td>
      <td>
        <ul>
     ...
     <tr>
      <td>
        <a href="https://future.utoronto.ca/apply/applying/" target="_BLANK"> University Of Toronto</a>
      </td>
      <td>
        <ul>
          <li>Não pode estar estudando  </li>
           <li>Precisa pagar uma taxa de $180 dólares se decidir aplicar(não é reembolsável)</li>
         <li>Não tem muitas informações, precisa se cadastrar</li>
        </ul>
      </td>
      <td>
...
<table role="table">
  ...
  <tbody>
    <tr>
      <td>
        <a href="https://worldprojects.columbia.edu/application-information" target="_BLANK">Obama Foundation Scholars</a>
      </td>
      <td>
        <ul>
        <li>
          Não é necessário uma graduação.
        </li>
        <li>
        O currículo/curriculum vitae deve ser uma lista cronológica do seu emprego e história académica, e outras actividades significativas, incluindo quaisquer prémios, publicações, ou outras achievements․
        </li>
         <li>
          Fluente em Inglês
            </l1>
...
<table role="table">
  ...
  <tbody>
    <tr>
      <td>
        <a href="https://www.fondation-hadamard.fr/fr/la-fmjh-soutient/formation/bourses-master/" target="_BLANK">Master Sophie Germain</a>
      </td>
      <td>
        <ul>
          <li>
          ...
          Os candidatos são selecionados com base em critérios acadêmicos atestados por histórico escolar e cartas de recomendação. 
            ...
            <li>
            Os estudantes estrangeiros também recebem uma  compensação fixa  de valor máximo de € 2.000 por ano</li>
        </ul>
      </td>
      <td>4 anos</td>
      <td>🟢 Aberto</td>
      <td>Final de janeiro(Não achei data)</td>
      <td>Todos os cursos, exceto Matemática e Aplicações</td>
    </tr>
  </tbody>
</table>
...
<table role="table">
  ...
  <tbody>
    <tr>
      <td>
        <a href="https://www.br.emb-japan.go.jp/itpr_pt/treinamento_prof.html" target="_BLANK">Estudo MEXT: Treinamento de Professores</a>
      </td>
      <td>
        <ul>
          <li>
          ...
          Sem taxa de inscrição
            ...
            <li> Idade: nascidos em ou após 2.abril.1987</li>
            <li>Conhecimento básico da língua japonesa</li>
            <li>Bolsa mensal de 143.000 ienes (aprox. R$6.919,00 em Jan/2022)</li>
            <li>Passagem de ida e volta e isenção de taxas escolares.</li>
        </ul>
      </td>
    ...
    <tr>
      <td>
        <a href="https://www.br.emb-japan.go.jp/itpr_pt/lingua_cultura.html" target="_BLANK">Estudo MEXT: Cultura e Língua Japonesa (Letras Japonês)  </a>
      </td>
      <td>
        <ul>
          <li>
...
Bom conhecimento da língua japonesa(Nível N3)
      ...
      <td>Letras Japonês</td>
       ...
       <tr>
      <td>
        <a href="https://www.br.emb-japan.go.jp/itpr_pt/lingua_cultura_nikkei.html" target="_BLANK">Estudo MEXT: Cultura e Língua Japonesa (Para Descendentes de Japoneses)</a>
      </td>
      <td>
        <ul>
     ...
     <td>2023 sem informações</td>
      ...
      <td> Estudante universitário de qualquer área.</td>
       ...
       <tr>
      <td>
        <a href="https://www.br.emb-japan.go.jp/itpr_pt/pesquisa.html" target="_BLANK">Bolsas de Estudo MEXT: Pós-graduação</a>
      </td>
      <td>
        <ul>
          <li>
     ...
     <td>2023 sem informações</td>
      ...
      <td>Qualquer área</td>
       ...
       <tr>
      <td>
        <a href="https://www.br.emb-japan.go.jp/itpr_pt/escola_tecnica.html" target="_BLANK">Bolsas de Estudo MEXT: Escola técnica</a>
      </td>
      <td>
        <ul>
        <li> 
          ...
          Sem taxa de inscrição
            ...
            <li>Os candidatos que obtiverem nota zero no exame de língua japonesa serão reprovados.  </li>
            <li>Bolsa no valor de 117.000 ienes (aprox. R$4.510,00 em Mai/2022) por mês. </li>
        </ul>
      </td>
      <td>4 anos</td>
     <td>2023 sem informações</td>
     ...
     <tr>
      <td>
        <a href="https://www.br.emb-japan.go.jp/itpr_pt/graduacao.html" target="_BLANK">Bolsas de Estudo MEXT: Graduação</a>
      </td>
      <td>
        <ul>
        <li> 
      ...
      <td><li> Geral 5 anos</li><li>Para Odontologia, Veterinária, Medicina e Farmácia, até março de 2030: 7 anos.</li><li>Bolsa no valor de 117.000 ienes (aprox. R$4.510,00 em maio/2022) por mês.</li></td>
     <td>2023 sem informações</td>
      <td>2023 sem informações</td> 
      <td>Diversas áreas</td>
    </tr>
     <tr>
      <td>
        <a href="https://www.br.emb-japan.go.jp/itpr_pt/curso_profission.html" target="_BLANK">Bolsas de Estudo MEXT: Curso Profissionalizante</a>
      </td>
      <td>
        <ul>
        <li> 
          ...
          Sem taxa de inscrição
            ...
            <li>É recomendável ter no mínimo um conhecimento básico da língua japonesa para participar da seleção. </li>
            <li>Os candidatos que obtiverem nota zero no exame de língua japonesa serão reprovados.  </li>
            <li> Bolsa no valor de 117.000 ienes (aprox. R$4.510,00 em maio/2022) por mês.</li>
        </ul>
      </td>
      <td>3 anos</td>
     <td>2023 sem informações</td>
